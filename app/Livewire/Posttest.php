...
class Posttest extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->hasFirstAttempt = UserTest::hasFirstAttempt($userId, 'posttest');
        $this->firstAttempt    = UserTest::getFirstAttempt($userId, 'posttest');
    ...
    public function submit(): void
    {
        ...
        $attemptNumber = UserTest::nextAttemptNumber($userId, 'posttest');
        ...
        $this->reloadNotif(
            'success',
            'Naisumite na!',
            "Nakuha mo ang {$score} sa 50 sa BASARO posttest. Maaari ka nang magsimula sa mga aralin!"
        );
