...
<main class="flex-1 flex flex-col gap-7">
    <div class="card flex flex-col gap-6">
        ...
        <div class="footer flex flex-col gap-4">
            ...
            <button class="w-fit !text-black px-4 py-2 bg-[#F4C300] text-gray-900 rounded-md font-bold" onclick="window.location.href='/lesson-view?lesson=1&slide=first-slide'">
                Start Lesson
            </button>
        </div>
    </div>
