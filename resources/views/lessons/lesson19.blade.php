...
<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg" x-data="{
    ...
    <div x-show="page === 3" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <header class="header flex-shrink-0">
            <h2 class="!text-lg sm:!text-2xl md:!text-3xl lg:!text-3xl font-bold !text-[#F4C300] text-center">TUITION FEE, LIBRE</h2>
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div @click="selectAnswer('q1', 'A')" 
                        ...
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">Senate Bill No. 177</p>
                    </div>
                    <div @click="selectAnswer('q1', 'B')" 
                         :class="answers.q1 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">Senate Bill No. 711</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div @click="selectAnswer('q2', 'A')" 
                         ...
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">Sarah Elago</p>
                    </div>
                    <div @click="selectAnswer('q2', 'B')" 
                         :class="answers.q2 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">Sarah Elegado</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div @click="selectAnswer('q3', 'A')" 
                         ...
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">Estudyanteng mahihirap</p>
                    </div>
                    <div @click="selectAnswer('q3', 'B')" 
                         :class="answers.q3 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">estudyanteng mayayaman</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div @click="selectAnswer('q4', 'A')" 
                         ...
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">Magsumikap mag-aral</p>
                    </div>
                    <div @click="selectAnswer('q4', 'B')" 
                         :class="answers.q4 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">magtambay</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div @click="selectAnswer('q5', 'A')" 
                         ...
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">Masinop na paggabay</p>
                    </div>
                    <div @click="selectAnswer('q5', 'B')" 
                         :class="answers.q5 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-4 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">masinop na opinya</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div x-show="page === 8" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <header class="header flex-shrink-0">
            <h2 class="!text-lg sm:!text-2xl md:!text-3xl lg:!text-3xl font-bold !text-[#F4C300] text-center">Edu-Aksyon</h2>
            <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl text-center">Jay Andrei Capuno</p>
        </header>
