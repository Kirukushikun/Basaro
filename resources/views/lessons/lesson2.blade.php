<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg">
    ...
    <div x-show="page === 1" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex items-center justify-center gap-10">
            @foreach (['A', 'E', 'I', 'O', 'U'] as $patinig)
                <p class="!text-5xl sm:!text-6xl md:!text-7xl lg:!text-8xl font-bold z-[2] cursor-pointer hover:scale-125 hover:!text-[#F4C300] transition-transform">{{ $patinig }}</p>
            @endforeach
        </div>
    </div>
    ...
    <div x-show="page === 3" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 !text-2xl sm:!text-3xl md:!text-3xl lg:!text-4xl font-bold text-center p-5 overflow-y-auto flex-1">
            @foreach ([
    ...
    <div x-show="page === 5" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            ...
            <p class="!text-sm sm:!text-base md:!text-lg lg:!text-xl !text-gray-300 mt-2">
                Basahin at bigkasin mo ang tunog ng letra.
            </p>
        </header>

        <div class="flex-1 flex items-center justify-center">
            <p class="!text-6xl sm:!text-7xl md:!text-8xl lg:!text-9xl font-bold !text-[#F4C300]">A</p>
        </div>
    </div>
    ...
    <div x-show="page === 8" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex items-center justify-center">
            <p class="!text-6xl sm:!text-7xl md:!text-8xl lg:!text-9xl font-bold !text-[#F4C300]">E</p>
        </div>
    </div>
    ...
    <div x-show="page === 11" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex items-center justify-center">
            <p class="!text-6xl sm:!text-7xl md:!text-8xl lg:!text-9xl font-bold !text-[#F4C300]">I</p>
        </div>
    </div>
    ...
    <div x-show="page === 14" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex items-center justify-center">
            <p class="!text-6xl sm:!text-7xl md:!text-8xl lg:!text-9xl font-bold !text-[#F4C300]">O</p>
        </div>
    </div>
    ...
    <div x-show="page === 17" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex items-center justify-center">
            <p class="!text-6xl sm:!text-7xl md:!text-8xl lg:!text-9xl font-bold !text-[#F4C300]">U</p>
        </div>
    </div>
