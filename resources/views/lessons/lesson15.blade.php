...
<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg">
    ...
    <div x-show="page === 1" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        ...
        <div class="flex-1 flex md:items-center md:justify-center md:px-8 overflow-y-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                ...
                <div class="bg-gray-800/50 p-8 rounded-lg border-2 border-[#F4C300] text-center">
                    <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-2xl font-bold !text-[#F4C300]">SALAWIKAIN</p>
                </div>
                <div class="bg-gray-800/50 p-8 rounded-lg border-2 border-[#F4C300] text-center">
                    <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-2xl font-bold !text-[#F4C300]">KASABIHAN</p>
                </div>
                <div class="bg-gray-800/50 p-8 rounded-lg border-2 border-[#F4C300] text-center">
                    <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-2xl font-bold !text-[#F4C300]">SAWIKAIN</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div x-show="page === 2" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <h1 class="!text-xl sm:!text-2xl md:!text-3xl lg:!text-4xl font-bold !text-[#F4C300]">BUGTONG</h1>
        </header>

        <div class="flex-1 flex flex-col items-center justify-center gap-6 p-8">
            <div class="bg-gray-800/50 p-10 rounded-lg border-2 border-[#F4C300] text-center">
                <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-semibold leading-relaxed">
                    Isang kuwadrong maliit,<br>
                    Naaabot ang buong daigdig.
                </p>
                <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-2xl !text-[#F4C300] font-bold mt-8">
                    Sagot: cellphone
                </p>
            </div>
        </div>
    ...
    <div x-show="page === 3" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8 overflow-y-auto p-5">
            <div class="bg-gray-800/50 p-8 rounded-lg border-2 border-[#F4C300] flex flex-col justify-center">
                ...
                <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-2xl !text-[#F4C300] font-bold text-center mt-6">
                    Sagot: mata
                </p>
            </div>
    ...
    <div x-show="page === 6" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <div class="flex-1 flex flex-col justify-center gap-10 p-8 overflow-y-auto">
            ...
            <div class="bg-gray-800/50 p-8 rounded-lg border-2 border-[#F4C300]">
                <p class="!text-lg sm:!text-2xl md:!text-2xl lg:!text-3xl font-bold !text-[#F4C300] text-center mb-4">madurukot</p>
                <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-semibold text-center">= makukuha, mahuhugot</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex-1 flex items-center justify-center p-8 overflow-y-auto">
            <div class="bg-gray-800/50 p-12 rounded-lg border-2 border-[#F4C300] text-center">
                ...
                <div class="border-t-2 border-gray-600 pt-8 mt-8">
                    <p class="!text-lg sm:!text-2xl md:!text-3xl lg:!text-3xl font-bold !text-[#F4C300]">PERA</p>
                    <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl mt-6">Mag-ipon = May magagamit</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div x-show="page === 8" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <h1 class="!text-xl sm:!text-2xl md:!text-3xl lg:!text-4xl font-bold !text-[#F4C300]">KASABIHAN</h1>
        </header>

        <div class="flex-1 flex flex-col items-center justify-center gap-6 p-8">
            <div class="bg-gray-800/50 p-10 rounded-lg border-2 border-[#F4C300] text-center">
                <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-bold leading-relaxed">
    ...
    <div x-show="page === 9" class="w-full flex-1 flex flex-col gap-6 px-2">
        <div class="flex-1 flex items-center justify-center p-8">
            <div class="bg-gray-800/50 p-12 rounded-lg border-2 border-[#F4C300] text-center max-w-4xl">
                <p class="!text-lg sm:!text-2xl md:!text-3xl lg:!text-3xl font-bold !text-[#F4C300] mb-8">matapat = hindi sinungaling</p>
                <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-semibold leading-relaxed">
    ...
    <div x-show="page === 12" class="w-full flex-1 flex flex-col gap-6 px-2">
        <div class="flex-1 flex items-center justify-center p-8">
            <div class="bg-gray-800/50 p-12 rounded-lg border-2 border-[#F4C300] text-center">
                <p class="!text-lg sm:!text-2xl md:!text-3xl lg:!text-3xl font-bold !text-[#F4C300] mb-10">Pusong mamon</p>
                <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-semibold">mamon = malambot</p>
                <div class="border-t-2 border-gray-600 pt-8 mt-8">
                    <p class="!text-lg sm:!text-2xl md:!text-2xl lg:!text-3xl font-bold">= malambot ang kalooban</p>
                    <p class="!text-lg sm:!text-2xl md:!text-2xl lg:!text-3xl font-bold mt-4">= mabait</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div x-show="page === 13" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <div class="flex-1 flex flex-col justify-center gap-6 overflow-y-auto p-5">
            <div class="grid grid-cols-2 gap-8 !text-base sm:!text-lg md:!text-xl lg:!text-2xl">
                <div class="bg-gray-800/50 p-6 rounded-lg border-2 border-[#F4C300]">
                    <p class="font-bold !text-[#F4C300] !text-lg sm:!text-xl md:!text-2xl lg:!text-3xl mb-3">Anak-dalita</p>
                    <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-3xl">= mahirap</p>
                </div>
                
                <div class="bg-gray-800/50 p-6 rounded-lg border-2 border-[#F4C300]">
                    <p class="font-bold !text-[#F4C300] !text-lg sm:!text-xl md:!text-2xl lg:!text-3xl mb-3">Malayo sa bituka</p>
                    <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-3xl">= hindi malubha ang sakit</p>
                </div>
                
                <div class="bg-gray-800/50 p-6 rounded-lg border-2 border-[#F4C300]">
                    <p class="font-bold !text-[#F4C300] !text-lg sm:!text-xl md:!text-2xl lg:!text-3xl mb-3">Butas ang bulsa</p>
                    <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-3xl">= walang pera</p>
                </div>
                
                <div class="bg-gray-800/50 p-6 rounded-lg border-2 border-[#F4C300]">
                    <p class="font-bold !text-[#F4C300] !text-lg sm:!text-xl md:!text-2xl lg:!text-3xl mb-3">Ilaw ng tahanan</p>
                    <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-3xl">= nanay / ina</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div x-show="page === 14" class="w-full flex-1 flex flex-col gap-6 px-2">
        <div class="flex-1 flex items-center justify-center">
            <div class="bg-gray-800/50 p-12 rounded-lg border-2 border-[#F4C300] text-center">
                <p class="!text-lg sm:!text-2xl md:!text-3xl lg:!text-3xl font-bold !text-[#F4C300] mb-8">Nakahiga sa salapi</p>
                <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-semibold">= ?</p>
            </div>
        </div>
    </div>
