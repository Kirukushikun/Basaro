...
<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg" x-data="{
    ...
    <div x-show="page === 2" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <header class="header flex-shrink-0">
            <h2 class="!text-xl sm:!text-2xl md:!text-3xl lg:!text-3xl font-bold !text-[#F4C300] text-center">Unang Araw ng Klase</h2>
            <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl text-center">Elvie M. Dimatulac</p>
        </header>
    ...
    <div x-show="page === 3" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex items-center justify-center">
            <div class="space-y-6 !text-base sm:!text-lg md:!text-xl lg:!text-2xl w-full max-w-3xl">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div @click="selectAnswer('q1', 'A')" 
                        ...
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">A. Kyel</p>
                    </div>
                    <div @click="selectAnswer('q1', 'B')" 
                         :class="answers.q1 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">B. Ken</p>
                    </div>
                    <div @click="selectAnswer('q1', 'C')" 
                         :class="answers.q1 === 'C' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">C. kuya</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div @click="selectAnswer('q2', 'A')" 
                         ...
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-base lg:!text-lg font-bold">A. umiyak sa kuwarto</p>
                    </div>
                    <div @click="selectAnswer('q2', 'B')" 
                         :class="answers.q2 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-base lg:!text-lg font-bold">B. Ngumiti na lang</p>
                    </div>
                    <div @click="selectAnswer('q2', 'C')" 
                         :class="answers.q2 === 'C' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-base lg:!text-lg font-bold">C. nag-ayos ng higaan</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div @click="selectAnswer('q3', 'A')" 
                         ...
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">A. si kuya Kyel</p>
                    </div>
                    <div @click="selectAnswer('q3', 'B')" 
                         :class="answers.q3 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">B. si nanay</p>
                    </div>
                    <div @click="selectAnswer('q3', 'C')" 
                         :class="answers.q3 === 'C' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">C. si tatay</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div @click="selectAnswer('q4', 'A')" 
                         ...
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-base lg:!text-lg font-bold">A. para kumain</p>
                    </div>
                    <div @click="selectAnswer('q4', 'B')" 
                         :class="answers.q4 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-base lg:!text-lg font-bold">B. dahil ayaw niyang mahuli sa pagpasok sa paaralan</p>
                    </div>
                    <div @click="selectAnswer('q4', 'C')" 
                         :class="answers.q4 === 'C' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-base lg:!text-lg font-bold">C. dahil tinawag na sila ng kanilang nanay</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div @click="selectAnswer('q5', 'A')" 
                         ...
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">A. Para bumiyahe</p>
                    </div>
                    <div @click="selectAnswer('q5', 'B')" 
                         :class="answers.q5 === 'B' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">B. Para maligo</p>
                    </div>
                    <div @click="selectAnswer('q5', 'C')" 
                         :class="answers.q5 === 'C' ? 'bg-[#F4C300] text-black' : 'bg-gray-800/50'"
                         class="p-2 rounded-lg border-2 border-[#F4C300] cursor-pointer hover:scale-105 transition-transform text-center">
                        <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-bold">C. para kumain</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div x-show="page === 5" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <header class="header flex-shrink-0">
            <h2 class="!text-xl sm:!text-2xl md:!text-3xl lg:!text-3xl font-bold !text-[#F4C300] text-center">Panalangin</h2>
            <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl text-center">Elvie M. Dimatulac</p>
        </header>
