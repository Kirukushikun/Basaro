...
<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg">
    ...
    <div x-show="page === 2" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex items-center justify-center">
            <p class="!text-6xl sm:!text-7xl md:!text-8xl lg:!text-9xl font-bold !text-[#F4C300]">M</p>
        </div>
    </div>
    ...
    <div x-show="page === 3" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex items-center justify-center">
            <p class="!text-6xl sm:!text-7xl md:!text-8xl lg:!text-9xl font-bold !text-[#F4C300]">S</p>
        </div>
    </div>
    ...
    <div x-show="page === 5" class="w-full flex-1 flex flex-col gap-6 px-2">
        ...
        <div class="flex-1 flex flex-col items-center justify-center gap-6">
            ...
            <div class="flex gap-8 !text-2xl sm:!text-3xl md:!text-4xl lg:!text-5xl font-bold">
                <p>ma</p>
                <p>ma</p>
                <p>ma</p>
            </div>
