<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg">
    ...
    <div x-show="page === 1" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <header class="header flex-shrink-0">
            <h1 class="!text-xl sm:!text-2xl md:!text-2xl lg:!text-3xl font-bold border-b border-gray-500 pb-4">
                <span class="!text-[#F4C300]">Sesyon 5:</span>
                Pagbubuo ng mga parirala at pangungusap
            </h1>
            <h1 class="!text-lg sm:!text-xl md:!text-xl lg:!text-2xl font-bold mt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 !text-2xl sm:!text-3xl md:!text-3xl lg:!text-4xl font-bold text-center p-5 overflow-y-auto flex-1">
            @foreach ([
                'Ang masa',
                'Si ama',
                'Ang masama',
    ...
    <div x-show="page === 2" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <h1 class="!text-lg sm:!text-xl md:!text-xl lg:!text-2xl font-bold">
        ...
        <div class="flex-1 flex flex-col items-center justify-center gap-8 p-5">
            @foreach ([
                ...
                <p class="!text-2xl sm:!text-3xl md:!text-3xl lg:!text-4xl font-bold cursor-pointer hover:scale-105 hover:!text-[#F4C300] transition-transform text-center">
                    {{ $sentence }}
                </p>
            @endforeach
        </div>
