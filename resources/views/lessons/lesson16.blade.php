...
<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg">
        ...
        <div class="flex-1 flex items-center md:justify-center p-8 overflow-y-auto">
            <div class="bg-gray-800/50 p-10 rounded-lg border-2 border-[#F4C300] max-w-4xl">
                ...
                <div class="border-t-2 border-gray-600 pt-8 mt-8">
                    <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-bold text-center">
    ...
    <div x-show="page === 5" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <div class="flex-1 flex flex-col items-center md:justify-center gap-8 pr-5 md:pr-0 overflow-y-auto">
            <div class="bg-gray-800/50 p-10 rounded-lg border-2 border-[#F4C300] w-full max-w-3xl">
                ...
                <div class="!text-lg sm:!text-xl md:!text-xl lg:!text-2xl leading-loose text-center">
                    <p>Ikaw, O ina ko,</p>
    ...
    <div x-show="page === 7" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <div class="flex-1 flex flex-col gap-6 overflow-y-auto p-8">
            ...
            <div class="bg-gray-800/50 p-6 rounded-lg border-2 border-[#F4C300]">
                <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-semibold">2. Sino ang sumulat ng tula?</p>
            </div>
            
            <div class="bg-gray-800/50 p-6 rounded-lg border-2 border-[#F4C300]">
                <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-semibold">3. Sa iyong palagay, sino ang nagsasalita sa tula?</p>
            </div>
            
            <div class="bg-gray-800/50 p-6 rounded-lg border-2 border-[#F4C300]">
                <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-semibold">4. Sino ang kinakausap niya sa tula?</p>
            </div>
            
            <div class="bg-gray-800/50 p-6 rounded-lg border-2 border-[#F4C300]">
                <p class="!text-base sm:!text-lg md:!text-lg lg:!text-xl font-semibold">5. Sino raw ang matigas ang bungo?</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex-1 flex flex-col md:items-center overflow-y-auto ">
            <div class="bg-gray-800/50 p-10 rounded-lg border-2 border-[#F4C300] w-full max-w-4xl">
                ...
                <div class="space-y-10">
                    <div class="!text-base sm:!text-lg md:!text-lg lg:!text-xl leading-loose">
