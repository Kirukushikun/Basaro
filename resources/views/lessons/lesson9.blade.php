<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg">
    ...
    <div x-show="page === 1" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            ...
            <p class="text-2xl font-semibold !text-gray-200">
                Mula sa mga letrang m, s, a, i, o, b, e, u, t, k, l, n, y, g, ng, p, r, d, h, w
            </p>
    ...
    <div x-show="page === 9" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                /ga/ pinagsamang tunog ng /g/ at /a/. Hindi lang ang pantig na /ga/ ang mabubuo natin kung pagsasamahin natin ang iba pang mga tunog ng patinig sa letrang g na may tunog na /g/.
            </p>
        </header>
    </div>
    ...
    <div x-show="page === 11" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                Bumuo tayo ng mga salitang gamit ang pantig na ga, ge, gi, go at gu kasama ang iba pang pantig na ating natalakay.
            </p>
        </header>
    </div>
    ...
    <div x-show="page === 13" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                /nga/ pinagsamang tunog ng /ng/ at /a/. Hindi lang ang pantig na /nga/ ang mabubuo natin kung pagsasamahin natin ang iba pang mga tunog ng patinig sa letrang ng na may tunog na /ng/.
            </p>
        </header>
    </div>
    ...
    <div x-show="page === 15" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                Bumuo tayo ng mga salitang gamit ang pantig na nga, nge, ngi, ngo at ngu kasama ang iba pang pantig na ating natalakay.
            </p>
        </header>
    </div>
    ...
    <div x-show="page === 19" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                Bumuo tayo ng mga salitang gamit ang pantig na pa, pe, pi, po at pu kasama ang iba pang pantig na ating natalakay.
            </p>
        </header>
    </div>
    ...
    <div x-show="page === 23" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                Bumuo tayo ng mga salitang gamit ang pantig na ra, re, ri, ro at ru kasama ang iba pang pantig na ating natalakay.
            </p>
        </header>
    </div>

    {{-- ===== PAGE 24 ===== --}}
    <div x-show="page === 24" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <header class="header flex-shrink-0">
            <p class="text-2xl font-semibold !text-gray-200">
                Halimbawa:
            </p>
    ...
    <div x-show="page === 27" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                Bumuo tayo ng mga salitang gamit ang pantig na da, de, di, do at du kasama ang iba pang pantig na ating natalakay.
            </p>
        </header>
    </div>
    ...
    <div x-show="page === 31" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                Bumuo tayo ng mga salitang gamit ang pantig na ha, he, hi, ho at hu kasama ang iba pang pantig na ating natalakay.
            </p>
        </header>
    </div>

    {{-- ===== PAGE 32 ===== --}}
    <div x-show="page === 32" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <header class="header flex-shrink-0">
            <p class="text-2xl font-semibold !text-gray-200">
                Halimbawa:
            </p>
    ...
    <div x-show="page === 35" class="w-full flex-1 flex flex-col gap-6 px-2">
        <header class="header">
            <p class="text-2xl font-semibold !text-gray-200">
                Bumuo tayo ng mga salitang gamit ang pantig na wa, we, wi, wo at wu kasama ang iba pang pantig na ating natalakay.
            </p>
        </header>
    </div>

    {{-- ===== PAGE 36 ===== --}}
    <div x-show="page === 36" class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        <header class="header flex-shrink-0">
            <p class="text-2xl font-semibold !text-gray-200">
                Halimbawa:
            </p>
