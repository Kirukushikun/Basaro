<div class="card w-full h-[70vh] min-h-[50vh] flex flex-col relative text-lg">
    {{-- ===== PAGE 1 ===== --}}
        ...
        <header class="header">
            ...
            <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-semibold !text-gray-200 mt-4">
    ...
    {{-- ===== PAGE 2 ===== --}}
    <div x-show="page === 2" class="w-full flex-1 flex flex-col gap-4 px-2 min-h-0">
        <div class="flex items-center justify-center p-4 flex-shrink-0">
        ...
        <div class="flex flex-col gap-4 overflow-y-auto flex-1">
            ...
            <div class="flex items-center">
                <p class="!text-lg sm:!text-xl md:!text-2xl lg:!text-3xl font-bold !text-[#F4C300]">
    ...
    <div x-show="page === 3" class="w-full flex-1 flex flex-col gap-6 px-2">
        <div class="flex-1 flex items-center justify-center">
            <div class="text-center">
                <p class="!text-base sm:!text-lg md:!text-xl lg:!text-2xl font-semibold !text-gray-200 mb-6">
                    Ilan ang pangungusap na bumbuo sa talatang ito? <br>
                    Sagutin mo nga. Kung tatlo ang iyong sagot, ito ay
                </p>
                <p class="!text-4xl sm:!text-5xl md:!text-6xl lg:!text-8xl font-bold !text-[#F4C300]">
                    TAMA
                </p>
            </div>
        </div>
    ...
    <div x-show="page === 4"
        ...
        class="w-full flex-1 flex flex-col gap-6 px-2 min-h-0">
        ...
        <div class="flex-1 flex flex-col gap-8 overflow-y-auto p-5">
            <template x-for="(q, index) in questions" :key="index">
                <div class="!text-lg sm:!text-2xl md:!text-2xl lg:!text-3xl font-bold flex flex-wrap items-center gap-3">
