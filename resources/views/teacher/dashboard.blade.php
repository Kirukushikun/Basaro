...
<div class="content flex-1 flex flex-col">
     ...
     <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 text-white">
          <div class="px-6 py-5 rounded-xl bg-[#31343A] shadow-sm flex justify-between items-center hover:-translate-y-2 hover:shadow-lg">
               ...
               <p class="text-sm font-semibold text-[#ADADAD]">Total Assets</p>
          ...
          <div class="px-5 py-5 rounded-xl bg-[#31343A] shadow-sm flex justify-between items-center hover:-translate-y-2 hover:shadow-lg">
               <div class="card-label">
               <p class="text-sm font-semibold text-[#ADADAD]">Assigned Assets</p>
               <h1 class="text-lg font-bold">11,256</h1>
               </div>
               <div class="card-icon p-2 rounded-xl bg-[#F4C300] text-xl">
          ...
          <div class="px-5 py-5 rounded-xl bg-[#31343A] shadow-sm flex justify-between items-center hover:-translate-y-2 hover:shadow-lg">
               <div class="card-label">
               <p class="text-sm font-semibold text-[#ADADAD]">Total Employees</p>
               <h1 class="text-lg font-bold">11,256</h1>
               </div>
               <div class="card-icon p-2 rounded-xl bg-[#F4C300] text-xl">
          ...
          <div class="px-5 py-5 rounded-xl bg-[#31343A] shadow-sm flex justify-between items-center hover:-translate-y-2 hover:shadow-lg">
               <div class="card-label">
               <p class="text-sm font-semibold text-[#ADADAD]">Pending Clearances</p>
               <h1 class="text-lg font-bold">11,256</h1>
               </div>
               <div class="card-icon p-2 rounded-xl bg-[#F4C300] text-xl">
     ...
     <div class="main-cards h-full grid-cols-1 lg:grid-cols-[calc(35%-10px)_calc(65%-10px)]">
          <div class="card flex flex-col gap-5">
               <div class="graph">
                    <div class="flex items-end bg-[#222427] rounded-xl p-[40px] pb-[65px] font-sans h-72 w-full">
                         <!-- Y-Axis -->
               ...
               <div class="asset-statuses grid grid-cols-2 gap-7 mb-5">
                    <div class="flex flex-col gap-1">
                         <div class="label flex items-center gap-2">
                              ...
                              <p class="text-sm text-[#ADADAD]">Available</p>
                         </div>
                    ...
                    <div class="flex flex-col gap-1">
                         <div class="label flex items-center gap-2">
                              ...
                              <p class="text-sm text-[#ADADAD]">Issued</p>
                         </div>
                         <div class="flex flex-col gap-2">
                              <h1 class="text-lg font-bold">2,016</h1>
                              <div class="bg-gray-200 w-full h-[4px] rounded-sm">
                    ...
                    <div class="flex flex-col gap-1">
                         <div class="label flex items-center gap-2">
                              ...
                              <p class="text-sm text-[#ADADAD]">transferred</p>
                         </div>
                         <div class="flex flex-col gap-2">
                              <h1 class="text-lg font-bold">2,016</h1>
                              <div class="bg-gray-200 w-full h-[4px] rounded-sm">
                    ...
                    <div class="flex flex-col gap-1">
                         <div class="label flex items-center gap-2">
                              ...
                              <p class="text-sm text-[#ADADAD]">For Disposal</p>
                         </div>
                         <div class="flex flex-col gap-2">
                              <h1 class="text-lg font-bold">2,016</h1>
                              <div class="bg-gray-200 w-full h-[4px] rounded-sm">
                    ...
                    <div class="flex flex-col gap-1">
                         <div class="label flex items-center gap-2">
                              ...
                              <p class="text-sm text-[#ADADAD]">Disposed</p>
                         </div>
                         <div class="flex flex-col gap-2">
                              <h1 class="text-lg font-bold">2,016</h1>
                              <div class="bg-gray-200 w-full h-[4px] rounded-sm">
                    ...
                    <div class="flex flex-col gap-1">
                         <div class="label flex items-center gap-2">
                              ...
                              <p class="text-sm text-[#ADADAD]">Lost</p>
                         </div>
                         <div class="flex flex-col gap-2">
                              <h1 class="text-lg font-bold">2,016</h1>
                              <div class="bg-gray-200 w-full h-[4px] rounded-sm">
